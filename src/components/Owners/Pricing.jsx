        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 max-w-screen-xl  justify-items-center gap-5   mx-auto justify-center py-14">
          <div className=" bg-white p-8 text-center  rounded-md shadow-xl max-w-md">
            <img
              ...
              className="mx-auto"
            />
            <h1 className="text-[32px] font-primary font-bold my-4 ">
              AUTOPILOT
            </h1>
            ...
            <p className="font-primary text-3xl mb-4">
            ...
            <Link
              to="/contact"
              className="my-4 font-bold px-8 py-3 bg-[#fc9f5b] rounded-md text-white"
            >
              Get Started
            </Link>
            <p className="mt-4  font-bold text-md tracking-wide">
          ...
          <div className="p-8 text-center  rounded-md shadow-xl bg-white  max-w-md">
            ...
            <img
              ...
              className="mx-auto"
            />
            <h1 className="text-[32px] font-primary font-semibold my-4 ">
              STANDARD
            </h1>
            <p className="font-semibold my-4 text-[#939494]">
            ...
            <Link
              to="/contact"
              className="my-4 font-bold px-8 py-3 bg-emerald-700 rounded-md text-white"
            >
              Get Started
            </Link>
            <p className="mt-4 font-bold text-md tracking-wide">
