...
const AboutView = () => {
  return (
    <>
      ...
      <div className="py-6">
        <p className="text-justify mb-4 px-6">
          ...
          operating, the course remains a mainstay in the DW area as a location
        ...
        <div className="border-2  p-4 border-green-800 border-r-0 border-l-0">
          <div className="h-full w-full ">
            ...
            <div className="flex justify-between flex-col md:flex-row w-full gap-y-4">
      ...
      <LeaveAMessage header={"intrested in joining our team?"} />
      <Footer />
    </>
  );
};
